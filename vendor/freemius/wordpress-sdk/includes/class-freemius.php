...
//			}
        ...
        private function _store_plans( $store = true ) {
            ...
            // Copy plans. Guard against _plans being false/non-array (PHP 8 compat).
            $encrypted_plans = array();
            $plans_list      = is_array( $this->_plans ) ? $this->_plans : array();
            for ( $i = 0, $len = count( $plans_list ); $i < $len; $i ++ ) {
                $encrypted_plans[] = self::_encrypt_entity( $plans_list[ $i ] );
            }
